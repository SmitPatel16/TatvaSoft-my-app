...
function BookListing() {
  ...
  // const materialClasses = materialCommonStyles();
    ...
    return(
        <>
            <div className="booklist_main_container">
                    <div className="title_underline">
                        <h1>Book Listing</h1>
                    </div>
            <Grid container className="title-wrapper">
                <Grid item xs={6}>
                    <div className="book_list_heading">
                        <p>
                            Total
                ...
                <div className="dropdown-wrapper">
                    <TextField
                        ...
                        name="text"
                        size="small"
                        className="dropdown-wrapper search_txt_field"
                ...
                <FormControl className="dropdown-wrapper form_wrapper" variant="outlined">
                  <InputLabel className="ip_label" htmlFor="select">Sort By</InputLabel>
                  <Select
              ...
              <div className="product-list" key={index}>
                <div className="product-list-inner">
                  ...
                  <div className="content-wrapper">
                    <p className="book_name" variant="h3">{book.name}</p>
